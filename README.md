...
### AI 文本分析
粘贴英文文本，AI 自动完成翻译、句子结构拆解、逐词标注释义。

![文本分析](screenshots/text.png)

### 智能词库
生词自动入库，支持按类型/状态筛选，附带来源上下文。

![词库管理](screenshots/vocabulary.png)
